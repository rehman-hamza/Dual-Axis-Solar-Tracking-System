...
// uRTCLib rtc; // Uncomment this line if you are using the default constructor
uRTCLib rtc(0x68); // Use this line to create an instance with a specific address
